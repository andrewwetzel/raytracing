...
fn test_azimuth_northeast_displaces_east() {
    ...
    let r = trace_ray(
        10.0, -1.0, 20.0, 45.0, 40.0, 2, 10.0, 200, 1e-4, 2e-6, 100.0, &p, 1,
    )
    .unwrap();
...
fn test_azimuth_northwest_displaces_west() {
    ...
    let r = trace_ray(
        10.0, -1.0, 20.0, 315.0, 40.0, 2, 10.0, 200, 1e-4, 2e-6, 100.0, &p, 1,
    )
    .unwrap();
    if r.returned_to_ground {
        let last = r.points.last().unwrap();
...
fn test_high_latitude_finite() {
    ...
    let result = trace_ray(
        10.0, -1.0, 20.0, 0.0, 80.0, 2, 10.0, 300, 1e-4, 2e-6, 100.0, &p, 1,
    )
    .unwrap();
    for pt in &result.points {
...
fn test_south_latitude_finite() {
    ...
    let result = trace_ray(
        10.0, -1.0, 20.0, 180.0, -60.0, 2, 10.0, 300, 1e-4, 2e-6, 100.0, &p, 1,
    )
    .unwrap();
    for pt in &result.points {
...
fn test_invalid_frequency_rejected() {
    let p = sample_params();
    let result = trace_ray(
        -5.0, -1.0, 20.0, 0.0, 40.0, 2, 10.0, 200, 1e-4, 2e-6, 100.0, &p, 10,
    );
...
fn test_invalid_elevation_rejected() {
    let p = sample_params();
    let result = trace_ray(
        10.0, -1.0, 100.0, 0.0, 40.0, 2, 10.0, 200, 1e-4, 2e-6, 100.0, &p, 10,
    );
...
fn test_zero_step_size_rejected() {
    let p = sample_params();
    let result = trace_ray(
        10.0, -1.0, 20.0, 0.0, 40.0, 2, 0.0, 200, 1e-4, 2e-6, 100.0, &p, 10,
    );
...
fn test_extreme_low_frequency() {
    ...
    let result = trace_ray(
        2.0, -1.0, 20.0, 0.0, 40.0, 2, 5.0, 500, 1e-4, 2e-6, 100.0, &p, 1,
    )
    .unwrap();
...
fn test_extreme_high_frequency() {
    ...
    let result = trace_ray(
        30.0, -1.0, 20.0, 0.0, 40.0, 2, 5.0, 500, 1e-4, 2e-6, 100.0, &p, 1,
    )
    .unwrap();
    assert!(result.n_steps > 0);
    for pt in &result.points {
...
fn test_extreme_low_elevation() {
    ...
    // 1° — nearly horizontal
    let result = trace_ray(
        10.0, -1.0, 1.0, 0.0, 40.0, 2, 5.0, 500, 1e-4, 2e-6, 100.0, &p, 1,
    )
    .unwrap();
    assert!(result.n_steps > 0);
    for pt in &result.points {
...
fn test_extreme_high_elevation() {
    ...
    // 89° — nearly vertical
    let result = trace_ray(
        10.0, -1.0, 89.0, 0.0, 40.0, 2, 5.0, 500, 1e-4, 2e-6, 100.0, &p, 1,
    )
    .unwrap();
    assert!(result.n_steps > 0);
    for pt in &result.points {
